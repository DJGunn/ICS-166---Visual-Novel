...
define jggf = Character(_("Gentle Giant"), color="#CF6800", image="jorggformal")
...
label start:
    ...
    l """But I dont understand. How will Grand Entrance allow me to do anything to the LOLs? They have countless GGs to fight for them, and if what you say is true
